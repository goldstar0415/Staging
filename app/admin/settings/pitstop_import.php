...
return [
    ...
    /**
     * The permission option is an authentication check that lets you define a closure that should return true if
     * the current user is allowed to view this settings page. Any "falsey" response will result in a 404.
     *
     * @type closure
     */
    'permission' => function () {
    ...
    'actions' => [
        ...
        'get_log' => [
            ...
            'action' => function(&$data)
            {
                return \App\Jobs\SpotsImport::getLog(\App\Jobs\SpotsImport::PITSTOP);
            }
        ],
        'crear_log' => [
            ...
            'action' => function(&$data)
            {
                return \App\Jobs\SpotsImport::removeLog(\App\Jobs\SpotsImport::PITSTOP);
            }
        ]
    ],
