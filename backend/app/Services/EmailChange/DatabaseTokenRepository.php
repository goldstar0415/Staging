...
class DatabaseTokenRepository implements TokenRepositoryInterface
{
     ...
     * @return array
     */
    protected function getPayload(Authenticatable $user, $email, $token)
    {
        return ['user_id' => $user->id, 'email' => $email, 'token' => $token, 'created_at' => new Carbon];
    }
    ...
    {
        return $this->getTable()->where('token', $token)->value('email');
    }
}